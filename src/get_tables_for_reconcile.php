...
<li><a class="dropdown-item"><input class="form-check-input column-checkbox tableColsChkBoxAll" type="checkbox" style="margin-right: 10px;"><label class="form-check-label" for="checkbox">Select All</label></a></li>
';
